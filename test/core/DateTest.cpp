...
void DateTest::DoTest()
{
	...
	TestEquals(d.GetTime(), (int64)0L, "jm::Date::GetTime() fails");
	...
	d = Date(1);
	TestEquals(d.GetTime(), (int64)1L, "jm::Date::GetTime() fails");
	...
	d = Date(2);
	TestEquals(d.GetTime(), (int64)2L, "jm::Date::GetTime() fails");
	...
	// 1. Jan. 1970   18:12:16
	d = Date(65536000);
	TestEquals(d.GetTime(), (int64)65536000L, "jm::Date::GetTime() fails");
	...
	TestEquals(d.GetTime(),-268435456000L, "jm::Date::GetTime() fails");
	...
	TestEquals(d.GetTime(),283996800000L, "jm::Date::GetTime() fails");
	...
	TestEquals(d.GetTime(),302313600000L, "jm::Date::GetTime() fails");
