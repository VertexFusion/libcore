...
void MatrixTest::doTest()
{
   ...
   Matrix A = Matrix(1, 1);
   testTrue(A.rows() == 1, "Matrix.rows() not 1");
   testTrue(A.cols() == 1, "Matrix.cols() not 1");


   A = Matrix(2, 2);
   testTrue(A.rows() == 2, "Matrix.rows() not 2");
   testTrue(A.cols() == 2, "Matrix.cols() not 2");
   ...
   A = Matrix(3, 3);
   testTrue(A.rows() == 3, "Matrix.rows() not 3");
   testTrue(A.cols() == 3, "Matrix.cols() not 3");
   ...
   A = Matrix(4, 4);
   testTrue(A.rows() == 4, "Matrix.rows() not 4");
   testTrue(A.cols() == 4, "Matrix.cols() not 4");
   ...
   testTrue(C.rows() == 2, "Matrix.rows() not 2");
   testTrue(C.cols() == 2, "Matrix.cols() not 2");
...
void MatrixTest::constructors()
{
   ...
   Matrix A;
   testTrue(A.rows() == 0, "Matrix.rows() not 0");
   testTrue(A.cols() == 0, "Matrix.cols() not 0");
