...
void SerializerTest::doTest()
{
    ...
    int32 count = jm::serializeBEInt16(buffer, 0, i16in);
    i16out = jm::deserializeBEInt16(buffer, 0);
    testEquals(count, 2, "int16 conversion failed");
    ...
    testEquals(count, 3, "int24 conversion failed");
    ...
    testEquals(count, 8, "int64 conversion failed");
    ...
    testEquals(count, 2, "uint16 conversion failed");
    ...
    testEquals(count, 4, "float conversion failed");
    ...
    testEquals(count, 8, "double conversion failed");
